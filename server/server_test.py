...
myMQTTClient.configureEndpoint('a1gbwzf7otibfp-ats.iot.us-west-2.amazonaws.com', 8883) # 管理画面で確認
myMQTTClient.configureCredentials(os.path.join(os.path.dirname(__file__),'data/rootCA.pem'),
 os.path.join(os.path.dirname(__file__),'data/fd35544055-private.pem.key'),
 os.path.join(os.path.dirname(__file__),'data/fd35544055-certificate.pem.crt'))
